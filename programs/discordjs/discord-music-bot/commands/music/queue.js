...
module.exports = {
    ...
    execute(client, message) {
        ...
        if (!queue || !queue.playing) return message.channel.send({ content: `${message.author}, 完全0歌，唔知播乜撚嘢 ❌` });

        if (!queue.tracks[0]) return message.channel.send({ content: `${message.author}, Add歌啦柒頭，未訓醒吖？ ❌` });
